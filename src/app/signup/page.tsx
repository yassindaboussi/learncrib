...
export default function SignupPage() {
  ...
  function handleSignup(e: React.FormEvent) {
    e.preventDefault();
    // No backend yet — simulates a successful signup.
    ...
    <main className="flex-1 flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-1.5 text-sm text-ink-soft text-center">
          Free to join. Pay only for courses you choose.
        </p>
        ...
        <p className="mt-6 text-center text-sm text-ink-soft">
          ...
          <Link href="/login" className="text-moss font-medium hover:text-moss-dark">
            Log in
          </Link>
        </p>
      </div>
